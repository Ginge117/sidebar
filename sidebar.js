        ...
        return (
            <div class="menu-div">
                ...
                {elements.map((value, index) => {
                    return <SideBarIcon src={value.src} text={value.text} />
                })}
            </div>
        );
    }
    ...
    render() {
        return (
            <div class="menu-container">
                <img src={props.src} class="menu-icon" />
                <div class="menu-text">{props.text}</div>
            </div>
        );
    }
}
...
class SideBarButton extends React.Component {
    ...
    render() {
        return (
            <button onClick={this.handleClick} class="menu" aria-label="Main Menu">
